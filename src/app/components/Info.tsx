...
const Info = () => {
  return (
    <>
      ...
      <div className="w-full mx-auto h-auto py-24">
        <div className="grid grid-cols-1 md:grid-cols-4 mx-auto gap-20">
          ...
          <div className="p-20">
            <div className="row-span-3 md:row-span-3 flex gap-10">
