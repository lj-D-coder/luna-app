    ...
    <div>
      <div className="flex items-center justify-center border-b-2 p-6 border-neutral-500 lg:justify-between">
        ...
        <div className="flex justify-center items-center">
          <a href="https://www.facebook.com/luna.naanna/" className="mr-6 text-neutral-200">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
            </svg>
          </a>
          <a href="https://x.com/luna_naanna" className="mr-6 text-neutral-200">
          ...
          <a href="http://www.youtube.com/@LUNANAANNA" className="mr-6 text-neutral-200">
          ...
          <a href="https://www.instagram.com/luna.naanna/" className="mr-6 text-neutral-200">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
