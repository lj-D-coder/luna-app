        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="text-gray-700 mt-8">
              Hate forms? Call us <a href="tel:+917428775548"><span className="underline">Click here.</span></a>
              </div>
              
              <div className="text-gray-700 text-base font-bold mt-4">
              <p>ADDRESS : <span className='text-gray-500 font-normal'> Moirangkhom Bazar, Near Brother and Sister Pharmacy, Imphal West, Manipur 795004 </span></p>
              </div>

              <div className="text-gray-700 text-base font-bold mt-2">
              <p>Phone No : <a href="tel:+917428775548"><span className='text-gray-500 font-normal'> +91 7428775548 </span> </a></p>
              </div>

              <div className="text-gray-700 text-base font-bold mt-2">
              <p>Email : <a href="mailto:imphal.lunanaanna@gmail.com?subject=Your%20Subject%20Here&body=Your%20Message%20Here"><span className='text-gray-500 font-normal'>imphal.lunanaanna@gmail.com</span> </a></p>
              </div>
      ...
      <div className="">
        ...
        <div className="mt-8">
          ...
          <textarea
            ...
            onChange={handleChange}
            required
            placeholder='Example: call me at 4:00 pm date 01/10/2024'
          ></textarea>
        </div>
        <div className="mt-8">
          <button
